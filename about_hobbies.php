						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										<li><a href="resume_education.php" id="layout2">EDUCATION</a></li>
										<li><a href="resume_position.php" id="layout3">POSITION</a></li>
										<li><a href="resume_awards.php" id="layout4">AWARDS</a></li>
									</ul>
								</li>
								<li>
									<a href="blog_post.php"><i class="icon-droplet2"></i> <span>BLOG-POST</span></a>
								</li>
								<li>
									<a href="service.php"><i class="icon-stack"></i> <span>SERVICES</span></a>
								</li>
								<li><a href="pricing.php"><i class="icon-list-unordered"></i> <span>PRICINGS</span></a></li>
								<li>
									<a href="skill.php"><i class="icon-pencil3"></i> <span>SKILLS</span></a>
								</li>
								<li>
									<a href="works.php"><i class="icon-footprint"></i> <span>WORKS</span></a>
								</li>
								<li>
									<a href="contact.php"><i class="icon-spell-check"></i> <span>CONTACTS</span></a>
								</li>
								<!-- /main -->
