					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									<a href="#"><i class="icon-stack2"></i> <span>ABOUTS</span></a>
									<ul>
							...
							<form action="#">
								<div class="panel panel-flat">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label>phone</label>
											<input type="phone" class="form-control" placeholder="Your strong password">
										</div>
										...
										<button href="about_add.php" type="button" class="btn btn-primary ui-wizard-content" id="add-step"><i class="icon-plus22"></i> Add More</button>
